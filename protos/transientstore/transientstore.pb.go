...
type TxPvtReadWriteSetWithConfigInfo struct {
	...
	CollectionConfigs map[string]*common2.CollectionConfigPackage `protobuf:"bytes,3,rep,name=collection_configs,json=collectionConfigs" json:"collection_configs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
